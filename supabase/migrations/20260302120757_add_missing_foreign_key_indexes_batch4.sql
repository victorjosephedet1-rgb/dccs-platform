/*
  ...
  1. Performance Improvements
    - Add indexes for foreign keys in DCCS dispute tables
    - Add indexes for foreign keys in dccs_download_history

  2. Tables Affected
    - dccs_dispute_activity_logs: actor_id, dispute_id
    - dccs_dispute_cases: certificate_id, claimant_id, resolved_by, respondent_id
    - dccs_dispute_escrow: dispute_id, held_by_admin_id, released_by_admin_id
    - dccs_disputes: assigned_admin_id, certificate_id, defendant_id, plaintiff_id, snippet_id
    - dccs_download_history: upload_id, user_id
*/
